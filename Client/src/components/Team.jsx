...
function Team() {
  ...
  const teamMembers = [
    { name: 'Shihara Sasangi', role: 'Co-founder | Team Leader', image: '/TeamMembers/Shihara Sasangi.jpeg' , link: "https://www.linkedin.com/in/shihara-sasangi-067353270" },
    ...
    { name: 'Chaninthu Sesanda', role: 'Co-founder', image: '/TeamMembers/Chaninthu Sesanda.jpeg' , link: "https://www.linkedin.com/in/chanithu-sesada-63774b305"},
    { name: 'Danindu Walisinghe', role: 'Co-founder', image: '/TeamMembers/Danindu Walisinghe.jpeg' , link: "https://www.linkedin.com/in/danidu-walisingha-181026216"}
  ]
    ...
    <section className="team-section" id="team">
      <div className="section-container">
        <div className="section-header">
          <h2>Meet the Team</h2>
          <p>The brilliant minds behind Universe3D</p>
        </div>
        <div className="team-grid">
          {teamMembers.map((member, index) => (
            <div key={index} className="team-card" data-animate>
